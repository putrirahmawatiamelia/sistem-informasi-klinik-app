...
INSERT INTO `pasien` (`id_pasien`, `nama`, `jenis_kelamin`, `alamat`, `tanggal_lahir`) VALUES
(1, 'John Doe', 'Laki-laki', 'Indonesia', '1990-01-09'),
(2, 'Sari', 'Perempuan', 'Bandung', '1999-09-09');
...
INSERT INTO `pegawai` (`id_pegawai`, `nama`, `jenis_kelamin`, `alamat`, `tanggal_lahir`) VALUES
(1, 'Putri Rahmawati Amelia', 'Perempuan', 'Sukajadi, Kota Bandung', '1998-08-16');
...
INSERT INTO `wilayah` (`id_wilayah`, `kode_wilayah`, `nama_wilayah`) VALUES
(1, 'BD001', 'Kota Bandung');
...
ALTER TABLE `transaksi`
  ...
  ADD CONSTRAINT `transaksi_ibfk_2` FOREIGN KEY (`id_tindakan`) REFERENCES `tindakan` (`id_tindakan`),
